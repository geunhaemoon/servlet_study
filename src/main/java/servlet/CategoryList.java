...
//		AtomicReference<String> reponseData = new AtomicReference<String>("");
//		
//		findFeedByCategory(categoryName).forEach(feed -> {
//			reponseData.set(reponseData.get() + feed.getFeedInfo());
//		});
//		
//		response.setCharacterEncoding("UTF-8");
//		response.getWriter().println(reponseData.getPlain());
//	}
